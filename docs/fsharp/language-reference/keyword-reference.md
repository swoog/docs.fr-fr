...
|`do`|[Liaisons do](functions/do-bindings.md)<br /><br />[Boucles : `for...to` Expression](loops-for-to-expression.md)<br /><br />[Boucles : `for...in` Expression](loops-for-in-expression.md)<br /><br />[Boucles : `while...do` Expression](loops-while-do-expression.md)|Utilisé dans les constructions de boucle ou pour exécuter du code impératif.|
...
|`downto`|[Boucles : `for...to` Expression](loops-for-to-expression.md)|Dans un `for` expression, utilisée lors du décompte dans l’ordre inverse.|
...
|`function`|[Expressions match](match-expressions.md)<br /><br />[Expressions lambda : Le mot clé fun](functions/lambda-expressions-the-fun-keyword.md)|Utilisé comme une alternative plus courte à la `fun` mot clé et un `match` expression dans une expression lambda qui a des critères spéciaux sur un seul argument.|
...
|`val`|[Champs explicites : le mot clé `val` ](members/explicit-fields-the-val-keyword.md)<br /><br />[Signatures](signatures.md)<br /><br />[Membres](members/index.md)|Utilisé dans une signature pour indiquer une valeur, ou dans un type pour déclarer un membre, dans des situations bien définies.|
