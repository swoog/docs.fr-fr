...
description: 'Découvrez comment utiliser les fichiers de signature F # pour conserver les informations sur les signatures publiques d’un jeu de F # d’éléments de programme, telles que des types, des espaces de noms et des modules.'
ms.date: 06/15/2018
