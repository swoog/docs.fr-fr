...
## <a name="using-tuples"></a><span data-ttu-id="b0aec-121">À l’aide de Tuples</span><span class="sxs-lookup"><span data-stu-id="b0aec-121">Using Tuples</span></span>
