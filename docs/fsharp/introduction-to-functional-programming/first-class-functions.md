...
## <a name="give-the-value-a-name"></a><span data-ttu-id="8844d-115">Donnez un nom à la valeur</span><span class="sxs-lookup"><span data-stu-id="8844d-115">Give the Value a Name</span></span>
