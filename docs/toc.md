...
### [Applications serverless : architecture, modèles et implémentation Azure](standard/serverless-architecture/)
## [Conseils sur la bibliothèque open source](standard/library-guidance/)
...
## [Traitement parallèle, simultané et asynchrone](standard/parallel-processing-and-concurrency.md)
...
### [Instructions d’utilisation de la mémoire<T> et de l’étendue<T>](standard/memory-and-spans/memory-t-usage-guidelines.md)
## [Interopérabilité native](standard/native-interop/index.md)
### [P/Invoke](standard/native-interop/pinvoke.md)
### [Marshaling de types](standard/native-interop/type-marshalling.md)
### [Personnalisation de marshaling de structures](standard/native-interop/customize-struct-marshalling.md)
### [Personnalisation de marshaling de paramètres](standard/native-interop/customize-parameter-marshalling.md)
### [Conseils d’interopérabilité](standard/native-interop/best-practices.md)
### [Jeux de caractères et marshaling](standard/native-interop/charset.md)
...
### [Déboguer une application Hello World .NET Core C# ou Visual Basic avec Visual Studio 2017](core/tutorials/debugging-with-visual-studio.md)
### [Publier votre application Hello World avec Visual Studio 2017](core/tutorials/publishing-with-visual-studio.md)
### [Générer une bibliothèque .NET Standard avec C# et .NET Core dans Visual Studio 2017](core/tutorials/library-with-visual-studio.md)
### [Générer une bibliothèque .NET Standard avec Visual Basic et .NET Core dans Visual Studio 2017](core/tutorials/vb-library-with-visual-studio.md)
### [Tester une bibliothèque .NET Standard avec .NET Core dans Visual Studio 2017](core/tutorials/testing-library-with-visual-studio.md)
### [Consommer une bibliothèque .NET Standard dans Visual Studio 2017](core/tutorials/consuming-library-with-visual-studio.md)
...
### [Nouveautés de .NET Core 3.0](core/whats-new/dotnet-core-3-0.md)
### [Nouveautés de .NET Core 2.2](core/whats-new/dotnet-core-2-2.md)
...
## Migration
### [.NET Core 2.0 vers 2.1](core/migration/20-21.md)
### [Migration à partir de project.json](core/migration/index.md)
...
### [Restauration par progression du runtime de déploiement autonome](core/deploying/runtime-patch-selection.md)
...
### [Mettre en conteneur une application .NET Core](core/docker/docker-basics-dotnet-core.md)
### [Utiliser des images de base Docker](core/docker/building-net-docker-images.md)
...
### [Outils globaux](core/tools/global-tools.md)
#### [Créer un outil global](core/tools/global-tools-how-to-create.md)
...
### [Activer la saisie semi-automatique via la touche TAB](core/tools/enable-tab-autocomplete.md)
...
### [Technologies .NET Framework non disponibles pour .NET Core](core/porting/net-framework-tech-unavailable.md)
...
### [Outils pour faciliter le portage vers .NET Core](core/porting/tools.md)
### [Utilisation du pack de compatibilité Windows](core/porting/windows-compat-pack.md)
### [Porter des projets Windows Forms](core/porting/winforms.md)
...
### [Présentation de C#](csharp/tutorials/intro-to-csharp/index.md)
#### [Hello world](csharp/tutorials/intro-to-csharp/hello-world.yml)
#### [Nombres en C#](csharp/tutorials/intro-to-csharp/numbers-in-csharp.yml)
#### [Branches et boucles](csharp/tutorials/intro-to-csharp/branches-and-loops.yml)
#### [Interpolation de chaîne](csharp/tutorials/intro-to-csharp/interpolated-strings.yml)
#### [Collections de listes](csharp/tutorials/intro-to-csharp/list-collection.yml)
#### [Travailler dans votre environnement local](csharp/tutorials/intro-to-csharp/local-environment.md)
##### [Nombres en C#](csharp/tutorials/intro-to-csharp/numbers-in-csharp-local.md)
##### [Branches et boucles](csharp/tutorials/intro-to-csharp/branches-and-loops-local.md)
##### [Interpolation de chaîne](csharp/tutorials/intro-to-csharp/interpolated-strings-local.md)
##### [Collections de listes](csharp/tutorials/intro-to-csharp/arrays-and-collections.md)
##### [Présentation des classes](csharp/tutorials/intro-to-csharp/introduction-to-classes.md)
### [Explorer C# 6](csharp/tutorials/exploration/csharp-6.yml)
### [Utiliser des types de référence Nullable](csharp/tutorials/nullable-reference-types.md)
### [Mettre à niveau une application avec des types référence nullable](csharp/tutorials/upgrade-to-nullable-references.md)
### [Générer et consommer des flux asynchrones](csharp/tutorials/generate-consume-asynchronous-stream.md)
### [Étendre les fonctionnalités de données à l’aide de critères spéciaux](csharp/tutorials/pattern-matching.md)
### [Application console](csharp/tutorials/console-teleprompter.md)
### [Client REST](csharp/tutorials/console-webapiclient.md)
### [Héritage dans C# et .NET](csharp/tutorials/inheritance.md)
### [Utilisation de LINQ](csharp/tutorials/working-with-linq.md)
### [Interpolation de chaîne](csharp/tutorials/string-interpolation.md)
### [Utilisation d’attributs](csharp/tutorials/attributes.md)
...
### [Considérations relatives à la version et la mise à jour](csharp/whats-new/version-update-considerations.md)
<!-- End What's New -->
...
### [Types de référence Nullable](csharp/nullable-references.md)
...
### [Écrire du code sécurisé et efficace](csharp/write-safe-efficient-code.md)
...
### [Analyser des chaînes à l’aide de `String.Split`](csharp/how-to/parse-strings-using-split.md)
### [Concaténer des chaînes](csharp/how-to/concatenate-multiple-strings.md)
### [Convertir une chaîne en DateTime](standard/base-types/parsing-datetime.md)
### [Rechercher des chaînes](csharp/how-to/search-strings.md)
### [Modifier du contenu de chaîne](csharp/how-to/modify-string-contents.md)
### [Comparer des chaînes](csharp/how-to/compare-strings.md)
### [Caster de manière sécurisée avec les critères spéciaux, ainsi que les opérateurs is et as](csharp/how-to/safely-cast-using-pattern-matching-is-and-as-operators.md)
...
### [Bien démarrer avec F# dans Visual Studio](fsharp/get-started/get-started-visual-studio.md)
### [Bien démarrer avec F# dans Visual Studio pour Mac](fsharp/get-started/get-started-with-visual-studio-for-mac.md)
### [Bien démarrer avec F# dans Visual Studio Code et Ionide](fsharp/get-started/get-started-vscode.md)
### [Bien démarrer avec F# dans le CLI .NET Core](fsharp/get-started/get-started-command-line.md)
...
#### [Fonctions de première classe](fsharp/introduction-to-functional-programming/first-class-functions.md)
...
### [Types de base](fsharp/language-reference/basic-types.md)
...
### [Sections](fsharp/language-reference/slices.md)
...
#### [Champs explicites : le mot clé `val` ](fsharp/language-reference/members/explicit-fields-the-val-keyword.md)
...
### [Déclarations d’importation : le mot clé open](fsharp/language-reference/import-declarations-the-open-keyword.md)
### [Fichiers de signature](fsharp/language-reference/signature-files.md)
...
### [Expressions différées](fsharp/language-reference/lazy-expressions.md)
...
##### [Guide pratique pour appeler un service web de manière asynchrone](visual-basic/developing-apps/programming/how-to-call-a-web-service-asynchronously.md)
...
### [Covariance et contravariance](visual-basic/programming-guide/concepts/covariance-contravariance/index.md)
...
##### [Guide pratique pour convertir un objet en un autre type](visual-basic/programming-guide/language-features/data-types/how-to-convert-an-object-to-another-type.md)
...
### [Guide pratique pour référencer les objets COM](visual-basic/programming-guide/com-interop/how-to-reference-com-objects.md)
...
### [Procédure pas à pas : créer des objets COM](visual-basic/programming-guide/com-interop/walkthrough-creating-com-objects.md)
...
### [Configurer la version de langage](visual-basic/language-reference/configure-language-version.md)
...
#### Liste des opérateurs Visual Basic
...
##### [<, opérateur](visual-basic/language-reference/operators/comparison-operators.md)
##### [<=, opérateur](visual-basic/language-reference/operators/comparison-operators.md)
##### [>, opérateur](visual-basic/language-reference/operators/comparison-operators.md)
##### [>=, opérateur](visual-basic/language-reference/operators/comparison-operators.md)
...
##### [?() (opérateur)](visual-basic/language-reference/operators/null-conditional-operators.md)
##### [?. Opérateur](visual-basic/language-reference/operators/null-conditional-operators.md)
...
#### [L’opération demandée n’est pas disponible (BC35000)](visual-basic/language-reference/error-messages/bc35000.md)
...
## Vue d'ensemble
### [Présentation de ML.NET](machine-learning/what-is-mldotnet.md)
### [Concepts de formation de modèle](machine-learning/basic-concepts-model-training-in-mldotnet.md)
...
### [Recommandation de films (recommandation)](machine-learning/tutorials/movie-recommmendation.md)
## [Guides pratiques](machine-learning/how-to-guides/index.md)
### Préparer les données
#### [Appliquer une ingénierie de fonctionnalité catégorielle](machine-learning/how-to-guides/train-model-categorical-ml-net.md)
#### [Appliquer une ingénierie de fonctionnalité textuelle](machine-learning/how-to-guides/train-model-textual-ml-net.md)
#### [Charger des données avec plusieurs colonnes](machine-learning/how-to-guides/load-data-from-mult-column-csv-ml-net.md)
#### [Fusionner des données à partir de plusieurs fichiers](machine-learning/how-to-guides/load-data-from-multiple-files-ml-net.md)
...
#### [Servir un modèle dans l’API Web](machine-learning/how-to-guides/serve-model-web-api-ml-net.md)
### Infer.NET
#### [Programmation probalistique avec Infer.NET](machine-learning/how-to-guides/matchup-app-infer-net.md)
## Référence
### [Informations de référence sur les API](https://docs.microsoft.com/dotnet/api/?view=ml-dotnet)
