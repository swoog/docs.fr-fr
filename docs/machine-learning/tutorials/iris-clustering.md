...
---
# <a name="tutorial-categorize-iris-flowers-using-a-clustering-model-with-mlnet"></a>Tutoriel : Classer les fleurs d’iris à l’aide d’un modèle de clustering ML.NET
