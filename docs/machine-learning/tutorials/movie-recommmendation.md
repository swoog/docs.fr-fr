...
`R Squared` est le pourcentage de variation dans les valeurs prédites expliqué par votre modèle. C’est une valeur comprise entre 0 et 1, et plus la valeur est proche de 0, meilleur est le modèle.
