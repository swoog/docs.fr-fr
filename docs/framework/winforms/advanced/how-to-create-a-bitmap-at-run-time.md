---
title: 'Procédure : Créer une Bitmap au moment de l’exécution'
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "54632411"
---
# <a name="how-to-create-a-bitmap-at-run-time"></a>Procédure : Créer une Bitmap au moment de l’exécution
