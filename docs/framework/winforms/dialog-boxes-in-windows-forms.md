...
-   [Comment : récupérer des informations de boîte de dialogue sélective à l’aide de plusieurs propriétés](https://msdn.microsoft.com/library/56taefba\(v=vs.110\))  
  
-   [Comment : récupérer des informations à partir du formulaire Parent d’une boîte de dialogue](https://msdn.microsoft.com/library/k70t19bb\(v=vs.110\))  
  
-   [Entrée utilisateur et les boîtes de dialogue](https://msdn.microsoft.com/library/1s9ws53w\(v=vs.110\))  
  
-   [Comment : récupérer le résultat des boîtes de dialogue](https://msdn.microsoft.com/library/40x40td1\(v=vs.110\))  
  
-   [Procédure pas à pas : Récupération des informations de boîte de dialogue collectivement à l’aide d’objets](https://msdn.microsoft.com/library/cakx2hdw\(v=vs.110\))  
  
-   [Comment : fermer les boîtes de dialogue et conserver l’entrée utilisateur](https://msdn.microsoft.com/library/65ad5907\(v=vs.110\))  
  
-   [Comment : créer des boîtes de dialogue au moment du Design](https://msdn.microsoft.com/library/55cz5x2c\(v=vs.110\))  
  
-   [Comment : afficher des boîtes de Message](https://msdn.microsoft.com/library/3tt9e94f\(v=vs.110\))  
