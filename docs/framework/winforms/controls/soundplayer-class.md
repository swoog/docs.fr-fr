...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Guide pratique pour Lire un son incorporé dans une ressource à partir d’un formulaire Windows](how-to-play-a-sound-embedded-in-a-resource-from-a-windows-form.md)  
