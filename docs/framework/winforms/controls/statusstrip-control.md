...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Consultez également [éditeur de collections d’éléments StatusStrip](https://msdn.microsoft.com/library/ms233631\(v=vs.110\)), [éditeur de collections d’éléments StatusStrip](https://msdn.microsoft.com/library/ms233642\(v=vs.110\)).  
