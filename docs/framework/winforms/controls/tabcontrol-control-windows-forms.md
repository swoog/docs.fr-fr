...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Voir également [Guide pratique pour Ajouter et supprimer des onglets avec le contrôle de TabControl Windows Forms à l’aide du concepteur](add-and-remove-tabs-with-wf-tabcontrol-using-the-designer.md), [Comment : Ajouter un contrôle à une Page d’onglets à l’aide du Concepteur](how-to-add-a-control-to-a-tab-page-using-the-designer.md)  
