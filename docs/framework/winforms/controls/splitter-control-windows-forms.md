...
> [!NOTE]
>  Bien que <xref:System.Windows.Forms.SplitContainer> remplace et ajoute des fonctionnalités à la `Splitter` contrôle des versions antérieures, `Splitter` est conservé pour la compatibilité descendante et l’utilisation future si vous choisissez.  
  
## <a name="in-this-section"></a>Dans cette section  
 [Vue d’ensemble du contrôle Splitter](../../../../docs/framework/winforms/controls/splitter-control-overview-windows-forms.md)  
