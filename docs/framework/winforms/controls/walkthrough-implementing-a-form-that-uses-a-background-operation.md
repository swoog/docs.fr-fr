...
1.  Créer un projet d’application Windows appelé `BackgroundWorkerExample` (**fichier** > **New** > **projet**  >  **Visual C#** ou **Visual Basic** > **bureau classique** > **Windows Forms Application**).  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [ABSENT DE LA BUILD : Multithreading en Visual Basic](http://msdn.microsoft.com/library/c731a50c-09c1-4468-9646-54c86b75d269)  
