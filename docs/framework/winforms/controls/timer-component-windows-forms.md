...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Guide pratique pour Exécuter des procédures à intervalles définis avec le composant Timer Windows Forms](run-procedures-at-set-intervals-with-wf-timer-component.md)  
