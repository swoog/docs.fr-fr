...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Guide pratique pour Insérer un MenuStrip dans un Menu du menu déroulant MDI](../../../../docs/framework/winforms/controls/how-to-insert-a-menustrip-into-an-mdi-drop-down-menu-windows-forms.md)  
 ...
 [Guide pratique pour Supprimer un ToolStripMenuItem d’un Menu du menu déroulant MDI](../../../../docs/framework/winforms/controls/how-to-remove-a-toolstripmenuitem-from-an-mdi-drop-down-menu-windows-forms.md)  
 Décrit comment définir plusieurs propriétés pour supprimer un élément de menu de la partie déroulante du menu MDI parent.  
  
 [Guide pratique pour Configuration de la vérification MenuStrip marges de sélection et Image](../../../../docs/framework/winforms/controls/how-to-configure-menustrip-check-margins-and-image-margins.md)  
 ...
 [Guide pratique pour Afficher les boutons d’Option dans un MenuStrip](../../../../docs/framework/winforms/controls/how-to-display-option-buttons-in-a-menustrip-windows-forms.md)  
...
-   [Procédure pas à pas : En fournissant des éléments de Menu Standard à un formulaire](walkthrough-providing-standard-menu-items-to-a-form.md)  
