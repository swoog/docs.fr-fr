...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Guide pratique pour Exposer les propriétés des contrôles constitutifs](../../../../docs/framework/winforms/controls/how-to-expose-properties-of-constituent-controls.md)  
