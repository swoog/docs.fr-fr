...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Guide pratique pour Activer l’affichage en mosaïque dans un contrôle de ListView Windows Forms](../../../../docs/framework/winforms/controls/how-to-enable-tile-view-in-a-windows-forms-listview-control.md)  
