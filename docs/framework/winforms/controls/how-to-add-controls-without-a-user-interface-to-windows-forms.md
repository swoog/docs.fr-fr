...
## <a name="add-a-component-to-a-windows-form"></a>Ajouter un composant à un formulaire Windows

1. Ouvrez le formulaire dans Visual Studio. Pour plus d’informations, consultez [Guide pratique pour Afficher des Windows Forms dans le concepteur](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/w5yd62ts(v=vs.100)).
...
## <a name="add-a-component-to-a-windows-form-programmatically"></a>Ajouter un composant à un formulaire Windows par programmation
