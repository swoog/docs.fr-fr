...
---
# <a name="how-to-create-an-mdi-form-with-menu-merging-and-toolstrip-controls"></a>Procédure : Créer un formulaire MDI avec la fusion de menus et des contrôles ToolStrip
