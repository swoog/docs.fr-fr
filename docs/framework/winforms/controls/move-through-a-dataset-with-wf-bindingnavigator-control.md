...
---
# <a name="how-to-move-through-a-dataset-with-the-windows-forms-bindingnavigator-control"></a>Procédure : Parcourir un DataSet avec le contrôle BindingNavigator Windows Forms
