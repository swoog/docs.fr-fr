...
ms.locfileid: "57702748"
---
# <a name="picturebox-control-windows-forms"></a>PictureBox, contrôle (Windows Forms)
Les formulaires Windows `PictureBox` contrôle est utilisé pour afficher des graphiques au format bitmap, GIF, JPEG, métafichier ou icône.  
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Explique ce que le <xref:System.Windows.Forms.PictureBox.SizeMode%2A> propriété et explique comment définir.  
