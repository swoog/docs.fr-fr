...
---
# <a name="how-to-display-web-style-links-with-the-windows-forms-richtextbox-control"></a>Procédure : Afficher les liens de Style Web avec le contrôle RichTextBox Windows Forms
