...
Le positionnement précis des contrôles sur votre formulaire constitue une haute priorité pour de nombreuses applications. Le **Windows Forms Designer** dans Visual Studio vous propose de nombreux outils de disposition pour effectuer cette opération. Trois des plus importants sont la <xref:System.Windows.Forms.Control.Margin%2A>, <xref:System.Windows.Forms.Control.Padding%2A>, et <xref:System.Windows.Forms.Control.AutoSize%2A> propriétés, qui sont présentes sur tous les contrôles Windows Forms.
...
1. Dans Visual Studio, créez un **Windows Application** projet appelé `LayoutExample`. Pour plus d'informations, voir [Procédure : Créer un projet d’application Windows Forms](/visualstudio/ide/step-1-create-a-windows-forms-application-project) .
...
### <a name="arrange-controls-on-your-form-using-the-margin-property"></a>Réorganiser des contrôles sur votre formulaire à l’aide de la propriété Margin
...
### <a name="arrange-controls-on-your-form-using-padding"></a>Réorganiser des contrôles sur votre formulaire à l’aide de la marge intérieure
...
### <a name="arrange-controls-on-your-form-using-the-autosize-property"></a>Réorganiser des contrôles sur votre formulaire à l’aide de la propriété AutoSize
...
### <a name="use-the-autosizemode-property"></a>Utilisez la propriété AutoSizeMode
