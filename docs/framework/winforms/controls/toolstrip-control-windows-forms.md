...
-   [Comment : créer un ToolStrip de formulaires Windows de base avec des éléments Standard à l’aide du Concepteur](https://msdn.microsoft.com/library/571c1z99\(v=vs.110\))  
