...
---
# <a name="how-to-display-the-printdialog-component"></a>Procédure : Afficher le composant PrintDialog
...
- [Guide pratique pour Créer des travaux d’impression Standard de Windows Forms](../../../../docs/framework/winforms/advanced/how-to-create-standard-windows-forms-print-jobs.md)
- [Guide pratique pour Capturer des entrées utilisateur à partir d’un composant PrintDialog au moment de l’exécution](../../../../docs/framework/winforms/advanced/how-to-capture-user-input-from-a-printdialog-at-run-time.md)
