...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Guide pratique pour Configuration de la vérification ContextMenuStrip marges de sélection et Image](how-to-configure-contextmenustrip-check-margins-and-image-margins.md)  
