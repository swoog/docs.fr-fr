...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Guide pratique pour Simuler des événements de souris et clavier dans le Code](how-to-simulate-mouse-and-keyboard-events-in-code.md)  
 Illustre différentes manières de simuler l'entrée de souris et de clavier par programmation.  
  
 [Guide pratique pour Gérer les événements d’entrée d’utilisateur dans les contrôles Windows Forms](how-to-handle-user-input-events-in-windows-forms-controls.md)  
...
## <a name="related-sections"></a>Rubriques connexes  
 Consultez également [création de gestionnaires d’événements dans les Windows Forms](creating-event-handlers-in-windows-forms.md).
