...
## <a name="in-this-section"></a>Dans cette section  
 [Guide pratique pour modifier les bordures des Windows Forms](../../../docs/framework/winforms/how-to-change-the-borders-of-windows-forms.md)  
