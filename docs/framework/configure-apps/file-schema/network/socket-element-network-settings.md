...
### <a name="attributes"></a><span data-ttu-id="38350-111">Attributs</span><span class="sxs-lookup"><span data-stu-id="38350-111">Attributes</span></span>  
