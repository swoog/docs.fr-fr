...
- [Améliorer les performances de lancement des applications de bureau](https://go.microsoft.com/fwlink/p/?LinkId=248943)
- [Vue d’ensemble des améliorations apportées aux performances de .NET 4.5](https://go.microsoft.com/fwlink/p/?LinkId=249131)
