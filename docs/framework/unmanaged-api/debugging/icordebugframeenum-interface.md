...
|Méthode|Description|  
|------------|-----------------|  
|[Next, méthode](../../../../docs/framework/unmanaged-api/debugging/icordebugframeenum-next-method.md)|Obtient le nombre spécifié de `ICorDebugFrame` les instances de l’énumération, en démarrant à la position actuelle.|  
