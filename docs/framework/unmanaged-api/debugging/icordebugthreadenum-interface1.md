...
|Méthode|Description|  
|------------|-----------------|  
|[Next, méthode](../../../../docs/framework/unmanaged-api/debugging/icordebugthreadenum-next-method.md)|Obtient le nombre spécifié de `ICorDebugThread` les instances de l’énumération, en démarrant à la position actuelle.|  
