...
|Méthode|Description|  
|------------|-----------------|  
|[Next, méthode](../../../../docs/framework/unmanaged-api/debugging/icordebugvalueenum-next-method.md)|Obtient le nombre spécifié de `ICorDebugValue` les instances de l’énumération, en démarrant à la position actuelle.|  
