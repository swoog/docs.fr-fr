...
`moduleAddr` [in] L’adresse du module pour récupérer des informations pour.

`data` [out] Le [DacpModuleData structure](dacpmoduledata-structure.md) pour contenir les informations du module chargé.
