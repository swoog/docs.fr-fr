...
|CLRDATA_ADDRESS|`typedef ULONG64 CLRDATA_ADDRESS;`|clrdata.h|Une adresse mémoire de 64 bits.|
...
|mdMethodDef|`typedef mdToken mdMethodDef;`|cordebug.h|Un jeton de définition de méthode.|
