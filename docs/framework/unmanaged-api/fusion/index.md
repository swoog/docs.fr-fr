...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit les fonctions statiques globales non managées que l’API de fusion utilise.  
  
 [Énumérations de fusion](../../../../docs/framework/unmanaged-api/fusion/fusion-enumerations.md)  
 Décrit les énumérations non managées utilisées par l’API de fusion.  
  
 [Structures de fusion](../../../../docs/framework/unmanaged-api/fusion/fusion-structures.md)  
 Décrit les structures non managées utilisées par l’API de fusion.
