...
|`tdImport`|<span data-ttu-id="5672b-128">Spécifie que le type est importé.</span><span class="sxs-lookup"><span data-stu-id="5672b-128">Specifies that the type is imported.</span></span>|  
