...
|`NATIVE_TYPE_R8`|<span data-ttu-id="dabe2-120">Une valeur numérique à virgule flottante de 8 octets.</span><span class="sxs-lookup"><span data-stu-id="dabe2-120">An 8-byte floating-point numeric value.</span></span>|  
