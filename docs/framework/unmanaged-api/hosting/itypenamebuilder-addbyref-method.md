...
---
# <a name="itypenamebuilderaddbyref-method"></a>ITypeNameBuilder::AddByRef, méthode
 ...
 **Plateformes :** WindoSee [requise](../../../../docs/framework/get-started/system-requirements.md).  
