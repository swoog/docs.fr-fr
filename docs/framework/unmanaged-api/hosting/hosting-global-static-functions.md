...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit les fonctions introduites dans le .NET Framework 4.  
  
 [Fonctions d’hébergement CLR dépréciées](../../../../docs/framework/unmanaged-api/hosting/deprecated-clr-hosting-functions.md)  
 Décrit les fonctions introduites dans le .NET Framework 1.1 et 2.0, qui sont déconseillées dans le [!INCLUDE[net_v40_long](../../../../includes/net-v40-long-md.md)].  
