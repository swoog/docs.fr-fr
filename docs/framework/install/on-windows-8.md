...
Ces instructions ont pour but de vous aider à installer les versions du .NET Framework dont vous avez besoin. [.NET Framework 4.7.2](https://go.microsoft.com/fwlink/?LinkID=863255) est la dernière version. Cette version est prise en charge sur Windows Server 2012, mais elle ne l’est pas sur Windows 8. Elle est fournie avec la [mise à jour d’avril 2018 de Windows 10](https://www.microsoft.com/software-download/windows10).
...
.NET Framework 4.7.2 est pris en charge sur Windows Server 2012. Cette version n’est pas prise en charge sur Windows 8.
