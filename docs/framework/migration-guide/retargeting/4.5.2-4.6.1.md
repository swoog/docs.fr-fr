...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-461"></a><span data-ttu-id="fa114-102">Modifications de reciblage pour la migration de .NET Framework 4.5.2 vers la version 4.6.1</span><span class="sxs-lookup"><span data-stu-id="fa114-102">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="fa114-103">Si vous effectuez une migration de .NET Framework 4.5.2 vers la version 4.6.1, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="fa114-103">If you are migrating from the .NET Framework 4.5.2 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="fa114-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="fa114-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="fa114-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="fa114-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="fa114-106">Principal</span><span class="sxs-lookup"><span data-stu-id="fa114-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="fa114-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="fa114-107">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="fa114-108">JIT</span><span class="sxs-lookup"><span data-stu-id="fa114-108">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="fa114-109">Réseau</span><span class="sxs-lookup"><span data-stu-id="fa114-109">Networking</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="fa114-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="fa114-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="fa114-111">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="fa114-111">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="fa114-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="fa114-112">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="fa114-113">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="fa114-113">XML, XSLT</span></span>
