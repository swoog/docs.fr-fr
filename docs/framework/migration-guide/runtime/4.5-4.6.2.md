...
ms.locfileid: "58465046"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-462"></a><span data-ttu-id="93817-102">Modifications du Runtime pour la migration de .NET Framework 4.5 vers la version 4.6.2</span><span class="sxs-lookup"><span data-stu-id="93817-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="93817-103">Si vous effectuez une migration de .NET Framework 4.5 vers la version 4.6.2, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="93817-103">If you are migrating from the .NET Framework 4.5 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="93817-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="93817-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="93817-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="93817-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="93817-106">Principal</span><span class="sxs-lookup"><span data-stu-id="93817-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="93817-107">Données</span><span class="sxs-lookup"><span data-stu-id="93817-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="93817-108">Débogueur</span><span class="sxs-lookup"><span data-stu-id="93817-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="93817-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="93817-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="93817-110">Globalisation</span><span class="sxs-lookup"><span data-stu-id="93817-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="93817-111">Réseau</span><span class="sxs-lookup"><span data-stu-id="93817-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="93817-112">Sécurité</span><span class="sxs-lookup"><span data-stu-id="93817-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="93817-113">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="93817-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="93817-114">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="93817-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="93817-115">Outils</span><span class="sxs-lookup"><span data-stu-id="93817-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="93817-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="93817-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="93817-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="93817-117">Windows Presentation Foundation (WPF)</span></span>
