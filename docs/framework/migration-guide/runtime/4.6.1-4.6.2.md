...
ms.locfileid: "59125851"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="f8288-102">Modifications du Runtime pour la migration de .NET Framework 4.6.1 vers la version 4.6.2</span><span class="sxs-lookup"><span data-stu-id="f8288-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="f8288-103">Si vous effectuez une migration de .NET Framework 4.6.1 vers la version 4.6.2, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="f8288-103">If you are migrating from the .NET Framework 4.6.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="f8288-104">Données</span><span class="sxs-lookup"><span data-stu-id="f8288-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="f8288-105">Globalisation</span><span class="sxs-lookup"><span data-stu-id="f8288-105">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="f8288-106">Sécurité</span><span class="sxs-lookup"><span data-stu-id="f8288-106">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="f8288-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="f8288-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="f8288-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="f8288-108">Windows Presentation Foundation (WPF)</span></span>
