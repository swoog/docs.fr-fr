...
ms.locfileid: "33389345"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a><span data-ttu-id="0a12a-102">Modifications du Runtime pour la migration de .NET Framework 4.6.1 vers la version 4.7</span><span class="sxs-lookup"><span data-stu-id="0a12a-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="0a12a-103">Si vous effectuez une migration de .NET Framework 4.6.1 vers la version 4.7, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="0a12a-103">If you are migrating from the .NET Framework 4.6.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="0a12a-104">Données</span><span class="sxs-lookup"><span data-stu-id="0a12a-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="0a12a-105">Globalisation</span><span class="sxs-lookup"><span data-stu-id="0a12a-105">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="0a12a-106">JIT</span><span class="sxs-lookup"><span data-stu-id="0a12a-106">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="0a12a-107">Sécurité</span><span class="sxs-lookup"><span data-stu-id="0a12a-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="0a12a-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="0a12a-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="0a12a-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="0a12a-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="0a12a-110">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="0a12a-110">Windows Workflow Foundation (WF)</span></span>
