...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-471"></a><span data-ttu-id="378ac-102">Modifications du Runtime pour la migration de .NET Framework 4.6.1 vers la version 4.7.1</span><span class="sxs-lookup"><span data-stu-id="378ac-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="378ac-103">Si vous effectuez une migration de .NET Framework 4.6.1 vers la version 4.7.1, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="378ac-103">If you are migrating from the .NET Framework 4.6.1 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="378ac-104">Données</span><span class="sxs-lookup"><span data-stu-id="378ac-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="378ac-105">Globalisation</span><span class="sxs-lookup"><span data-stu-id="378ac-105">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="378ac-106">Sécurité</span><span class="sxs-lookup"><span data-stu-id="378ac-106">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="378ac-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="378ac-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="378ac-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="378ac-108">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="378ac-109">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="378ac-109">Windows Workflow Foundation (WF)</span></span>
