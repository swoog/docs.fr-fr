...
ms.locfileid: "50194759"
---
# <a name="net-framework-guide"></a>Guide du .NET Framework

> [!NOTE]
> Dans cette documentation du .NET Framework, vous trouverez des informations relatives aux versions 4.5, 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7, 4.7.1 et 4.7.2. Pour télécharger le .NET Framework, consultez [Installation du .NET Framework](../../docs/framework/install/guide-for-developers.md). Pour obtenir la liste des nouvelles fonctionnalités et des modifications dans le .NET Framework 4.5, [!INCLUDE[net_v46](../../includes/net-v46-md.md)], leurs versions intermédiaires et le .NET Framework 4.7, 4.7.1 et 4.7.2, consultez [Nouveautés du .NET Framework](../../docs/framework/whats-new/index.md). Pour obtenir la liste des plateformes prises en charge, consultez la [Configuration requise pour .NET Framework](../../docs/framework/get-started/system-requirements.md). 
...
[Bibliothèque de classes .NET Framework](/dotnet/api/?view=netframework-4.7.2)   
