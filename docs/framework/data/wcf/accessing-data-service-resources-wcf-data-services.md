...
```  
 ...
 Pour plus d’informations, consultez [OData : Résoudre les liens entre les entrées](https://go.microsoft.com/fwlink/?LinkId=187351).  
...
- [Site Web du protocole Open Data](https://go.microsoft.com/fwlink/?LinkID=182204)
