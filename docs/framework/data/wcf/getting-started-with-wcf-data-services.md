...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit comment travailler avec [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] flux.  
 ...
 Montre comment créer et accéder à une simple [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)]-en fonction de service qui expose un flux basé sur la base de données Northwind.  
