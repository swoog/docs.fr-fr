...
|[Truncate(expression)](../../../../../docs/framework/data/adonet/ef/language-reference/date-and-time-canonical-functions.md)|Pour SQL Server 2000 et SQL Server 2005, un texte tronqué `datetime` valeur mise en forme est créée sur le serveur. Pour SQL Server 2008 et versions ultérieures, une `datetime2` ou `datetimeoffset` valeur est créée sur le serveur.|  
...
|[Droite (string1, longueur)](../../../../../docs/framework/data/adonet/ef/language-reference/string-canonical-functions.md)|`RIGHT (string1, length)`|  
...
|Fonctions canoniques|Fonctions SQL Server|  
|-------------------------|--------------------------|  
|[BitWiseAnd (value1, value2)](../../../../../docs/framework/data/adonet/ef/language-reference/bitwise-canonical-functions.md)|value1 et value2|  
