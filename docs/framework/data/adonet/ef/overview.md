...
-   [Donner vie aux modèles](#LifeToModels)  
...
## <a name="learning-more"></a>En savoir plus  
 ...
 Fournissent des informations sur comment être opérationnel et en cours d’exécution rapidement à l’aide de la [Quickstart](https://msdn.microsoft.com/library/0bc534be-789f-4819-b9f6-76e51d961675), qui montre comment créer un simple [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] application.  
