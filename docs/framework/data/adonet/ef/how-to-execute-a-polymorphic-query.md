...
3.  Modifier le modèle conceptuel pour avoir un héritage table par hierrachy en suivant les étapes décrites dans [procédure pas à pas : Mappage de l’héritage - TPH par Table](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/cc716683(v=vs.100)).  
