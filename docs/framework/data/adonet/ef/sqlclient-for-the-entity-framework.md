...
## <a name="provider-schema-attribute"></a>Attribut de schéma Provider  
 `Provider` est un attribut de la `Schema` élément dans le langage de définition de schéma de magasin (SSDL).  
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Problèmes connus dans SqlClient pour l'Entity Framework](../../../../../docs/framework/data/adonet/ef/known-issues-in-sqlclient-for-entity-framework.md)  
