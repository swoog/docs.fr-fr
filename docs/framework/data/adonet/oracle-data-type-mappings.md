...
|**BLOB**||**Objet BLOB**|Oracle n’autorise la liaison un **BLOB** comme un **BLOB** paramètre. Le fournisseur de données .NET pour Oracle ne construit pas automatiquement un pour vous si vous tentez de lier un non -**BLOB** de valeurs, tels que **byte []** ou <xref:System.Data.OracleClient.OracleBinary>.|  
...
|**ENTIER NON SIGNÉ**|**Byte, UInt16, UInt32, UInt64, Decimal**|**Octet, UInt16, Uint32, nombre**|<xref:System.Data.OracleClient.OracleParameter.Size%2A> Détermine la **System.Data.DBType** et <xref:System.Data.OracleClient.OracleType>.|  
