...
## <a name="see-also"></a><span data-ttu-id="de675-104">Voir aussi</span><span class="sxs-lookup"><span data-stu-id="de675-104">See Also</span></span>  
 [<span data-ttu-id="de675-105">REF CURSOR Oracle</span><span class="sxs-lookup"><span data-stu-id="de675-105">Oracle REF CURSORs</span></span>](../../../../docs/framework/data/adonet/oracle-ref-cursors.md)  
 [<span data-ttu-id="de675-106">Fournisseurs managés ADO.NET et centre de développement DataSet</span><span class="sxs-lookup"><span data-stu-id="de675-106">ADO.NET Managed Providers and DataSet Developer Center</span></span>](http://go.microsoft.com/fwlink/?LinkId=217917)
