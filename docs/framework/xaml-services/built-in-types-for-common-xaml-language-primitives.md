...
### <a name="xboolean"></a>x:Boolean  
 ...
 XAML analyse les valeurs de `x:Boolean` sans respect de la casse. Notez que `x:Bool` n'est pas une alternative acceptée. Pour la définition de la spécification du langage XAML, consultez [ \[MS-XAML\] Sections 5.2.17 et 5.4.11](https://go.microsoft.com/fwlink/?LinkId=114525).  
  
### <a name="xchar"></a>x:Char  
 Pour le stockage CLR, la primitive `x:Char` correspond à <xref:System.Char>.  
  
 Les types de chaîne et de caractère ont une interaction avec l'encodage global du fichier au niveau XML. Pour la définition de la spécification du langage XAML, consultez [ \[MS-XAML\] Sections 5.2.7 et 5.4.1](https://go.microsoft.com/fwlink/?LinkId=114525).  
  
### <a name="xstring"></a>x:String  
 Pour le stockage CLR, la primitive `x:String` correspond à <xref:System.String>.  
  
 Les types de chaîne et de caractère ont une interaction avec l'encodage global du fichier au niveau XML. Pour la définition de la spécification du langage XAML, consultez [ \[MS-XAML\] Sections 5.2.6](https://go.microsoft.com/fwlink/?LinkId=114525).  
...
### <a name="xsingle"></a>x:Single  
 ...
 Pour la définition de la spécification du langage XAML, consultez [ \[MS-XAML\] Sections 5.2.8 et 5.4.2](https://go.microsoft.com/fwlink/?LinkId=114525).  
...
### <a name="xdouble"></a>x:Double  
 ...
 Pour la définition de la spécification du langage XAML, consultez [ \[MS-XAML\] Sections 5.2.9 et 5.4.3](https://go.microsoft.com/fwlink/?LinkId=114525).  
...
### <a name="xint16"></a>x:Int16  
 ...
 Pour la définition de la spécification du langage XAML, consultez [ \[MS-XAML\] Sections 5.2.11 et 5.4.5](https://go.microsoft.com/fwlink/?LinkId=114525).  
...
### <a name="xint32"></a>x:Int32  
 ...
 Pour la définition de la spécification du langage XAML, consultez [ \[MS-XAML\] Sections 5.2.12 et 5.4.6](https://go.microsoft.com/fwlink/?LinkId=114525).  
...
### <a name="xint64"></a>x:Int64  
 ...
 Pour la définition de la spécification du langage XAML, consultez [ \[MS-XAML\] Sections 5.2.13 et 5.4.7](https://go.microsoft.com/fwlink/?LinkId=114525).  
...
### <a name="xtimespan"></a>x:TimeSpan  
 ...
 Pour la définition de la spécification du langage XAML, consultez [ \[MS-XAML\] Sections 5.2.16 et 5.4.10](https://go.microsoft.com/fwlink/?LinkId=114525).  
...
### <a name="xuri"></a>x:Uri  
 ...
 Pour la définition de la spécification du langage XAML, consultez [ \[MS-XAML\] Sections 5.2.15 et 5.4.9](https://go.microsoft.com/fwlink/?LinkId=114525).  
  
### <a name="xbyte"></a>x:Byte  
 Pour le stockage CLR, la primitive `x:Byte` correspond à <xref:System.Byte>. Un <xref:System.Byte>  /  `x:Byte` est considéré comme non signée.  
  
 Pour la définition de la spécification du langage XAML, consultez [ \[MS-XAML\] Sections 5.2.10 et 5.4.4](https://go.microsoft.com/fwlink/?LinkId=114525).  
