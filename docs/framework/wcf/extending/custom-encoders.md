...
## <a name="how-to-work-with-system-provided-encoders"></a>Comment utiliser des encodeurs fournis par le système  
 ...
 WCF fournit les types suivants d’éléments de liaison dérivés de la <xref:System.ServiceModel.Channels.MessageEncodingBindingElement> classe qui fournisse texte, binaire et encodage (Message Transmission Optimization Mechanism) :  
