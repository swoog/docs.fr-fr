...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit les modules de formatage de message personnalisé qui peuvent être utilisés pour contrôler la sérialisation et la désérialisation d’un message WCF en types CLR.
