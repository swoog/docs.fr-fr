...
- Intégration à .NET Framework remoting est expliquée dans [migration d’Applications .NET Remoting vers WCF](../../../docs/framework/wcf/feature-details/migrating-net-remoting-applications-to-wcf.md).  
