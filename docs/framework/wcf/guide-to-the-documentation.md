...
-   Pour intégrer une application MSMQ existante à un client ou un service WCF, consultez [Comment : Exchange en file d’attente des Messages avec les points de terminaison WCF](../../../docs/framework/wcf/feature-details/how-to-exchange-queued-messages-with-wcf-endpoints.md) et [Comment : échanger des Messages avec les points de terminaison WCF et Message Queuing Applications](../../../docs/framework/wcf/feature-details/how-to-exchange-messages-with-wcf-endpoints-and-message-queuing-applications.md).  
...
-   Pour utiliser WCF pour utiliser un service Web Services Extensions (WSE) 3.0, consultez [Comment : accéder à un Service 3.0 de WSE](../../../docs/framework/wcf/feature-details/how-to-access-a-wse-3-0-service-with-a-wcf-client.md).  
