...
-   [Guide pratique pour Configurer un Client](../../../docs/framework/wcf/how-to-configure-a-basic-wcf-client.md) fournit un exemple de création d’un client à l’aide de la configuration.  
