...
## <a name="description"></a>Description  
 Cet événement est émis lorsque la génération du writer par DataContract commence.  
  
## <a name="message"></a>Message  
 Début de la génération de l'enregistreur %1 par DataContract pour %2.  
