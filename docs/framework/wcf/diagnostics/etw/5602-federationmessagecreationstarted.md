...
## <a name="description"></a>Description  
 Cet événement est émis lorsque la création du message de fédération à partir de la publication de formulaire a commencé.  
  
## <a name="message"></a>Message  
 Début de la création d'un message de fédération à partir de la publication de formulaire.  
