...
## <a name="description"></a>Description  
 Cet événement est émis lorsque le BufferPool alloue de la mémoire pour les mémoires tampons.  
  
## <a name="message"></a>Message  
 Le pool est en train d'allouer %1 octets.  
