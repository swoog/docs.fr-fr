...
Le tableau suivant définit les niveaux d’événement, les identificateurs et les messages associés le traçage analytique de WCF.  
...
|[3308 - ClientBaseUsingLocalChannelFactory](../../../../../docs/framework/wcf/diagnostics/etw/3308-clientbaseusinglocalchannelfactory.md)|Information|N’utilisez ne pas de fabrique de canaux à partir du cache, par exemple, la mise en cache désactivée par exemple.|ServiceModel|  
...
|[3374 - MtomMessageDecodingStart](../../../../../docs/framework/wcf/diagnostics/etw/3374-mtommessagedecodingstart.md)|Verbose|Mtommessageencoder a commencé à décoder le message.|Canal|  
