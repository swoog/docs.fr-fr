...
## <a name="description"></a>Description  
 Cet événement est émis lorsqu'une fabrique des canaux correspondante utilisée est trouvée dans le cache.  
  
## <a name="message"></a>Message  
 Une fabrique de canaux correspondante trouvée dans le cache a été utilisée.  
