...
## <a name="description"></a>Description  
 Cet événement est émis lorsque le Thread d’e/s rappel du Planificateur de code non managé se termine.  
  
## <a name="message"></a>Message  
 Rappel du Planificateur de Thread d’e/s invoqué.  
