...
## <a name="description"></a>Description  
 Cet événement est émis pour fournir les informations de ratio des connexions sortantes par point de terminaison.  
  
## <a name="message"></a>Message  
 Ratio des connexions sortantes par point de terminaison : %1/%2  
