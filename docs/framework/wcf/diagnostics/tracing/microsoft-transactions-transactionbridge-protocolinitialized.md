...
Le service de protocole WS-Atomic Transaction a été initialisé.  
  
## <a name="description"></a>Description  
 Suivi lors du démarrage du gestionnaire de transactions afin d’indiquer le protocole qui a été correctement initialisé.  
