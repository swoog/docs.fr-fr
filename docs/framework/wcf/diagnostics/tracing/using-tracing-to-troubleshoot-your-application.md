...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit les suivis utilisés pour les scénarios de WCF de E2E, par exemple, les demandes-réponses wsHttp synchrones et les demandes unidirectionnelles TCP.  
