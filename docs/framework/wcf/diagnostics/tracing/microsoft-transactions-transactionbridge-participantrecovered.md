...
Une inscription de participant a été récupérée à partir du journal du gestionnaire de transactions.  
  
## <a name="description"></a>Description  
 Tracé lorsque le Gestionnaire de transactions local a effectué la récupération correcte d’une inscription de participant subalterne donnée.  
