...
## <a name="in-this-section"></a>Dans cette section  
 [Activité](../../../../../docs/framework/wcf/diagnostics/tracing/activity.md): décrit les suivis d’activité dans le modèle de suivi Windows Communication Foundation (WCF).  
  
 [Transfert](../../../../../docs/framework/wcf/diagnostics/tracing/transfer.md): décrit le transfert dans le modèle de suivi Windows Communication Foundation (WCF) et à l’aide de transfert pour corréler des activités au sein des points de terminaison.  
  
 [Propagation](../../../../../docs/framework/wcf/diagnostics/tracing/propagation.md): décrit la propagation d’activité dans le Windows Communication Foundation (WCF) suivi du modèle et à l’aide de la propagation pour corréler des activités sur les points de terminaison.  
