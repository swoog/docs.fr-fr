...
## <a name="description"></a>Description  
 Une entrée de journal de récupération n'a pas pu être générée pour l'enrôlement du coordinateur. La transaction sera abandonnée. Cet événement répertorie l'ID de transaction, la raison, l'exception, le nom et l'ID de processus.  
