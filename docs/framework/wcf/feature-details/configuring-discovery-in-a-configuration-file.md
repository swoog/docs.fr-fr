...
```  
 ...
 Pour plus d’informations sur les points de terminaison standard consultez [points de terminaison Standard](../../../../docs/framework/wcf/feature-details/standard-endpoints.md)
