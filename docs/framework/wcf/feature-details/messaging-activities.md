...
- **Duplex** : lorsque vous en utilisant le MEP le client et un service duplex peut envoyer des messages entre eux dans n’importe quel ordre. Le MEP duplex est similaire à une conversation téléphonique, où chaque mot prononcé correspond à un message.
...
## <a name="messaging-activities-and-message-exchange-patterns"></a>Activités de messagerie et des modèles d’échange de message
...
- [Comment envoyer et recevoir des erreurs dans les Services de flux de travail](https://go.microsoft.com/fwlink/?LinkId=189151)
