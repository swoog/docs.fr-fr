...
- `KeyType`  
 ...
 À partir du fichier de configuration client, WCF ne peut pas faire la différence entre les paramètres de service et client. Par conséquent, WCF convertit tous les paramètres à un espace de noms de version 1.3 de confiance.  
