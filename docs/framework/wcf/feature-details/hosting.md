...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit comment un service Windows Communication Foundation (WCF) est hébergé dans Internet Information Services ou [Windows Server AppFabric](http://go.microsoft.com/fwlink/?LinkId=196496).  
 ...
 Décrit comment un service WCF est hébergé dans IIS ou WAS sans utiliser un fichier .svc.  
