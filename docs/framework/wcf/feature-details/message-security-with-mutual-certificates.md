...
## <a name="see-also"></a>Voir aussi  
 ...
 [Comment : créer et installer des certificats temporaires dans WCF pour la sécurité de Transport pendant le développement](https://go.microsoft.com/fwlink/?LinkId=244264)
