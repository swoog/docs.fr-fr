...
Le client de jeton émis permet le scénario de sécurité fédérée dans Windows Communication Foundation (WCF).  
 ...
 Pour obtenir une explication détaillée sur les scénarios fédérés, consultez [fédération et jetons émis](../../../../docs/framework/wcf/feature-details/federation-and-issued-tokens.md).  
