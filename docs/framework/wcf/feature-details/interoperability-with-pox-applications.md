...
> [!NOTE]
> Ce document a été initialement écrit pour le .NET Framework 3.0.  .NET framework 3.5 prend en charge pour l’utilisation des applications POX. Pour plus d’informations sur, consultez [modèle de programmation WCF Web HTTP](../../../../docs/framework/wcf/feature-details/wcf-web-http-programming-model.md).
