...
ms.locfileid: "33492705"
---
# <a name="interoperability-and-integration"></a>Interopérabilité et intégration
Cette section aborde l’interopérabilité et intégration avec Windows Communication Foundation (WCF).  
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 WCF est conçu pour interagir avec les services Web qui prennent en charge un ensemble de spécifications connues sous les spécifications des services Web. Cette rubrique répertorie les spécifications prises en charge ainsi que les liaisons qui les prennent en charge.  
 ...
 Décrit comment WCF peut être utilisée avec [!INCLUDE[dnprdnshort](../../../../includes/dnprdnshort-md.md)] la communication à distance.  
 ...
 Décrit comment migrer un service Web WSE 3.0 à un service WCF.  
 ...
 Décrit comment migrer un [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] Web service à un service WCF.  
 ...
 Décrit comment WCF fournit les services et les clients qui utilisent des messages de « Plain Old XML » (POX).  
