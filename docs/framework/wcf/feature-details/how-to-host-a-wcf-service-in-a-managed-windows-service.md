...
5. <span data-ttu-id="c064e-125">Ajoutez les instructions using suivantes à Service.cs.</span><span class="sxs-lookup"><span data-stu-id="c064e-125">Add the following using statements to Service.cs.</span></span>
