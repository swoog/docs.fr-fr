...
|Messagerie|MTOM|[MTOM](https://go.microsoft.com/fwlink/?LinkId=95326)<br /><br /> `basicHttpBinding`, `wsHttpBinding`, et `ws2007HttpBinding` prennent en charge de Message Transmission Optimization Mechanism (MTOM). Non utilisé par défaut. Pour utiliser MTOM, affectez `messageEncoding` à l'attribut `"Mtom"`.<br /><br /> Exemple :<br /><br /> `<wsHttpBinding> <binding messageEncoding="Mtom"/> </wsHttpBinding>`|  
...
|Category|Protocole|Spécification et utilisation|  
|--------------|--------------|-----------------------------|  
|Messagerie|SOAP 1.2|[Initiation](https://go.microsoft.com/fwlink/?LinkId=48282)<br /><br /> [Infrastructure de messagerie  (page pouvant être en anglais)](https://go.microsoft.com/fwlink/?LinkId=94664)<br /><br /> [Compléments (y compris la liaison HTTP)](https://go.microsoft.com/fwlink/?LinkId=95329)|  
|Messagerie|WS-Addressing 2005/08|[Web Services Addressing 1.0 – Core](https://go.microsoft.com/fwlink/?LinkId=90574)<br /><br /> [Web Services Addressing 1.0 - SOAP  (page pouvant être en anglais)](https://go.microsoft.com/fwlink/?LinkId=95330)<br /><br /> `wsHttpBinding`, `ws2007HttpBinding` et `wsDualHttpBinding` implémentent la recommandation W3C (World Wide Web Consortium) WS-Addressing pour activer la messagerie asynchrone, la corrélation de messages et les mécanismes d’adressage indépendant du transport.<br /><br /> WCF ne prend pas en charge le chiffrement des en-têtes WS-Addressing bien que cela soit autorisé par les spécifications WS-*.|  
...
|Messagerie|SOAP 1.2|[Initiation](https://go.microsoft.com/fwlink/?LinkId=48282)<br /><br /> [Infrastructure de messagerie  (page pouvant être en anglais)](https://go.microsoft.com/fwlink/?LinkId=94664)<br /><br /> [Compléments (y compris la liaison HTTP)](https://go.microsoft.com/fwlink/?LinkId=95329)|  
|Messagerie|WS-Addressing 2005/08|[Web Services Addressing 1.0 – Core](https://go.microsoft.com/fwlink/?LinkId=90574)<br /><br /> [Web Services Addressing 1.0 - SOAP  (page pouvant être en anglais)](https://go.microsoft.com/fwlink/?LinkId=95330)|  
|Métadonnées|WS-MetadataExchange|[WS-MetadataExchange](https://go.microsoft.com/fwlink/?LinkId=94868)<br /><br /> WCF implémente WS-MetadataExchange pour récupérer le schéma XML, WSDL et WS-Policy.|  
