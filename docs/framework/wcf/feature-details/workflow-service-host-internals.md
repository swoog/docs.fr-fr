...
## <a name="workflowservicehost-overview"></a>Vue d'ensemble WorkflowServiceHost  
 ...
 ![Vue d’ensemble de WorkflowServiceHost](../../../../docs/framework/wcf/feature-details/media/wfshhighlevel.gif "WFSHHighLevel")  
...
## <a name="workflowservicehost-details"></a>Détails de WorkflowServiceHost  
 ...
 ![Si WorkflowServiceHost.Open est appelé](../../../../docs/framework/wcf/feature-details/media/wfhostopen.gif "WFHostOpen")  
