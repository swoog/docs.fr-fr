...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Concepts relatifs au canal de l’homologue](../../../../docs/framework/wcf/feature-details/peer-channel-concepts.md): décrit des mailles homologues, de nœuds homologues, de sécurité de canal homologue et de programmes de résolution homologues.  
...
## <a name="peer-channel-code-examples"></a>Exemples de code de canal homologue  
 [Résolution d’homologue personnalisé de canal homologue](https://msdn.microsoft.com/library/5b75a2bb-7ff1-4a14-abe7-3debf0537d23)  
