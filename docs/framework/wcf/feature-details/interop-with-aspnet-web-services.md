...
- [Procédure : configurer le service WCF pour interagir avec des clients de services web ASP.NET](../../../../docs/framework/wcf/feature-details/config-wcf-service-with-aspnet-web-service.md)
