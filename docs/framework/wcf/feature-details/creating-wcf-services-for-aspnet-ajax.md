...
-   Ajoutez un point de terminaison compatible AJAX à un service [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] à l'aide de la configuration. Pour plus d’informations, consultez [Comment : utiliser la Configuration pour ajouter un point de terminaison ASP.NET AJAX](../../../../docs/framework/wcf/feature-details/how-to-use-configuration-to-add-an-aspnet-ajax-endpoint.md).  
