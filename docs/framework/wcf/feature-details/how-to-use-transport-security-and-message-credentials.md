...
#### <a name="to-use-the-wshttpbinding"></a><span data-ttu-id="f63b8-149">Pour utiliser la liaison WSHttpBinding</span><span class="sxs-lookup"><span data-stu-id="f63b8-149">To use the WSHttpBinding</span></span>  
