...
## <a name="defining-endpoint-addresses-in-configuration"></a>Définition des adresses de point de terminaison dans la configuration  
 Pour définir un point de terminaison dans un fichier de configuration, utilisez le [ \<point de terminaison >](../configure-apps/file-schema/wcf/endpoint-element.md) élément.  
