...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Montre comment utiliser le traçage analytique dans WCF pour émettre des événements dans Event Tracing pour Windows (ETW).  
 ...
 Montre comment contrôler diverses fonctionnalités de sécurité d’un service WCF.  
  
 [Utilisation des compteurs de performance](../../../../docs/framework/wcf/samples/using-performance-counters.md)  
 Montre comment accéder aux compteurs de performance WCF et comment créer des compteurs de performance définis par l’utilisateur.  
