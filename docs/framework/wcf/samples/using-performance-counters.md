...
3.  Ajouter des compteurs de WCF en double-cliquant sur le volet du graphique et en sélectionnant **ajouter des compteurs**. Dans le **ajouter des compteurs** boîte de dialogue, sélectionnez **ServiceModelOperation 3.0.0.0, ServiceModelEndpoint 3.0.0.0 ou ServiceModelService 3.0.0.0** dans l’objet de Performance, faites glisser la zone de liste. Sélectionnez les compteurs que vous souhaitez afficher dans la liste.  
  
    > [!NOTE]
    >  Il n’existe aucun compteur de performance pour un service WCF si aucun service WCF en cours d’exécution sur l’ordinateur.  
