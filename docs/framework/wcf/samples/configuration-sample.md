...
```  
 ...
 Pour plus d’informations sur les étendues, consultez [recherche de découverte et FindCriteria](../../../../docs/framework/wcf/feature-details/discovery-find-and-findcriteria.md).  
