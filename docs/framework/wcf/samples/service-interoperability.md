...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Montre comment créer un service à l’aide de WCF et ensuite d’accéder au service à partir d’un client non-WCF, tel qu’un client ASMX.
