...
2. <span data-ttu-id="acc41-127">Permettez à plusieurs projets de démarrer.</span><span class="sxs-lookup"><span data-stu-id="acc41-127">Enable multiple projects to start up.</span></span>
