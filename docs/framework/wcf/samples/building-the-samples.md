...
2.  Si le service est un type hébergé sur le Web, utilisez la commande suivante.  
    ...
    ```  
     ...
     Remplacez http://localhost:8000/ServiceModelSamples/service.svc/mex avec l’adresse du point de terminaison mex du service auto-hébergé.  
