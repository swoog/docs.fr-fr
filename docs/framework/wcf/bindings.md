...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Vue d’ensemble de quelles liaisons WCF faire, les liaisons, le système fournit, et comment vous pouvez définir ou modifier les.  
  
 [Liaisons fournies par le système](../../../docs/framework/wcf/system-provided-bindings.md)  
 Liste des liaisons fournies avec WCF. Ces liaisons couvrent la plus grande partie des exigences de modèle de message et de sécurité.  
