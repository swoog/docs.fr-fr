...
## <a name="example"></a>Exemple  
 ...
 La première technique a tendance à être plus rapides pour [!INCLUDE[TLA2#tla_win32](../../../includes/tla2sharptla-win32-md.md)] contrôles, mais la deuxième est plus rapide pour les contrôles Windows Presentation Foundation (WPF).  
