...
|<xref:System.Windows.Automation.WindowInteractionState>|Événement|N’est pas garanti pour être <xref:System.Windows.Automation.WindowInteractionState.ReadyForUserInteraction>|  
