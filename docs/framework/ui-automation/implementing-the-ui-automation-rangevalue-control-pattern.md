...
|--------------------|---------------|  
|<xref:System.ArgumentOutOfRangeException>|<xref:System.Windows.Automation.RangeValuePattern.SetValue%2A> est appelé avec une valeur qui est soit supérieure à <xref:System.Windows.Automation.RangeValuePattern.MaximumProperty> ou inférieur à <xref:System.Windows.Automation.RangeValuePattern.MinimumProperty>.|  
