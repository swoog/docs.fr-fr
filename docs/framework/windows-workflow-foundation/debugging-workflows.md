...
## <a name="remote-debugging"></a>Remote Debugging  
 Débogage à distance de Windows Workflow Foundation (WF) fonctionne comme un débogage à distance pour les autres composants de Visual Studio. Pour plus d’informations sur l’utilisation du débogage à distance, consultez [Comment : activer le débogage à distance](https://go.microsoft.com/fwlink/?LinkId=196257).  
