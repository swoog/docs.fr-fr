...
## <a name="description"></a>Description  
 Cet événement est émis par le participant de suivi ETW lorsqu’une instance de workflow émet un événement WorkflowInstanceRecord pour les États de flux de travail : Démarré, repris, persistant, inactif, supprimé, terminé, annulé, déchargé, soit réactivé.  
