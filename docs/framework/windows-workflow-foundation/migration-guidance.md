...
## <a name="wf-migration-whitepapers-and-cookbooks"></a>Livres blancs et livres de recettes sur la migration WF (en anglais)  
 ...
 [Guide de Migration WF : Suivi de workflow](https://go.microsoft.com/fwlink/?LinkId=275562)  
 ...
 [Guide de WF : Services de workflow](https://go.microsoft.com/fwlink/?LinkId=275564)  
