...
Cette section contient un ensemble de rubriques d’initiation que vous devez connaître pour devenir un expert programmeur Windows Workflow Foundation (WF).  
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Rubriques qui décrivent comment migrer un flux de travail à partir de versions précédentes de Windows Workflow Foundation (WF).  
 ...
 Explique comment sécuriser votre flux de travail lors de l’utilisation de SQL et Windows Communication Foundation (WCF).  
  
 [Performances de Windows Workflow Foundation 4](performance.md)  
 Décrit les performances de Windows Workflow Foundation 4 et le compare à la version précédente de WF.
