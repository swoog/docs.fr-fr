...
> [!NOTE]
>  La prise en charge des expressions C# dans les projets de workflow a été introduite dans [!INCLUDE[net_v45](../../../includes/net-v45-md.md)]. Pour plus d’informations, consultez [ C# Expressions](csharp-expressions.md).  
