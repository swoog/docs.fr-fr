...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Guide pratique pour Créer un Participant de suivi de personnalisés](how-to-create-a-custom-tracking-participant.md)  
 ...
 [Guide pratique pour Mise à jour la définition d’une Instance de Workflow en cours d’exécution](how-to-update-the-definition-of-a-running-workflow-instance.md)  
