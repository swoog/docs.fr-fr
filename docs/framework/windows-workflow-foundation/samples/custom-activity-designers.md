...
## <a name="in-this-section"></a>Dans cette section  
 [Concepteurs composites personnalisés : présentateur d’élément de workflow](../../../../docs/framework/windows-workflow-foundation/samples/custom-composite-designers-workflow-item-presenter.md)  
 Cet exemple montre comment créer un concepteur d’activités qui fait apparaître telle « zone de dépôt. »  
