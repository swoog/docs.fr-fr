...
-   À l’aide de configuration de Windows Communication Foundation (WCF) pour définir des points de terminaison sécurisés pour une utilisation par le service de flux de travail.  
