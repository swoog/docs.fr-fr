...
## <a name="in-this-section"></a>Dans cette section  
 [Guide pratique pour Créer un concepteur d’activités personnalisées](how-to-create-a-custom-activity-designer.md)  
...
## <a name="external-resources"></a>Ressources externes  
 [Activités personnalisées](./samples/custom-activities.md)
