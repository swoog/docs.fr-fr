...
---
# <a name="how-to-animate-camera-position-and-direction-using-key-frames"></a>Procédure : Animer la position et la direction de la caméra à l’aide d’images clés
