...
Les pinceaux d’image peuvent remplir des formes, des contrôles, du texte, etc.  
 ...
 Pour plus d’informations sur <xref:System.Windows.Media.ImageBrush> et voir des images de peinture [peinture avec des Images, de dessin et visuels](../../../../docs/framework/wpf/graphics-multimedia/painting-with-images-drawings-and-visuals.md).  
