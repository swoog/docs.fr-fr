...
## <a name="example"></a>Exemple  
 ...
 Pour plus d’informations sur <xref:System.Windows.Media.VisualBrush> et obtenir des exemples supplémentaires, consultez le [peinture avec des Images, de dessin et visuels](painting-with-images-drawings-and-visuals.md) vue d’ensemble.  
