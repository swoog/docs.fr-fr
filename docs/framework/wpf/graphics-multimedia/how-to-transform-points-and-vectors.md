...
ms.locfileid: "61797161"
---
# <a name="how-to-transform-points-and-vectors"></a>Procédure : Transformer des points et des vecteurs
Cet exemple montre comment utiliser un <xref:System.Windows.Media.Matrix> pour transformer <xref:System.Windows.Point> et <xref:System.Windows.Vector> objets.  
