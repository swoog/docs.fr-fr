...
## <a name="example"></a>Exemple  
 L’exemple suivant crée un <xref:System.Windows.Media.ArcSegment> qui anime sa <xref:System.Windows.Media.ArcSegment.Size%2A> lors de son chargement à l’écran.  
 ...
 Pour géométriques supplémentaires et des exemples d’animation, consultez le [géométries, exemple](https://go.microsoft.com/fwlink/?LinkID=159989).  
