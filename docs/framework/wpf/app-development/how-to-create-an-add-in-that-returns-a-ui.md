...
ms.locfileid: "33548231"
---
# <a name="how-to-create-an-add-in-that-returns-a-ui"></a>Comment : créer un complément qui retourne une interface utilisateur
Cet exemple montre comment créer un complément qui retourne une application Windows Presentation Foundation (WPF) vers un ordinateur hôte [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] application autonome.  
