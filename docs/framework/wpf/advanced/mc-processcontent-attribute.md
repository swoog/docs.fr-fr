...
|*[contenu]*|*ThisElementCanBeIgnored* est marqué comme pouvant être ignoré. Si le processeur ignore cet élément, *[content]* est traité par *objet*.|  
