...
ms.locfileid: "61780625"
---
# <a name="wpf-unmanaged-api-reference"></a>Informations de référence sur les API non managées WPF
Les bibliothèques Windows Presentation Foundation (WPF) exposent plusieurs fonctions non managées qui sont destinées à un usage interne uniquement. Ils ne doivent pas être appelées à partir du code de l’utilisateur.  
