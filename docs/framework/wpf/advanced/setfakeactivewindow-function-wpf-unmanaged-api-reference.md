...
---
# <a name="setfakeactivewindow-function-wpf-unmanaged-api-reference"></a>Fonction SetFakeActiveWindow (référence des API non managées WPF)
 ...
 **Version du .NET framework :** [!INCLUDE[net_current_v40plus](../../../../includes/net-current-v40plus-md.md)]  
