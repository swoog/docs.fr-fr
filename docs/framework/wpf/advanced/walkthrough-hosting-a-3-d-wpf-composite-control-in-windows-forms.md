...
1.  Ajouter un **application WPF (.NET Framework)** projet nommé `WpfUserControlHost` à la solution. Pour plus d'informations, consultez [Guide pratique pour créer un projet d'application WPF](https://msdn.microsoft.com/library/1f6aea7a-33e1-4d3f-8555-1daa42e95d82).
