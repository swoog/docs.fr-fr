...
1.  Ajouter un **application WPF (.NET Framework)** projet nommé `WpfUserControlHost` à la solution. Pour plus d'informations, consultez [Guide pratique pour créer un projet d'application WPF](http://msdn.microsoft.com/library/1f6aea7a-33e1-4d3f-8555-1daa42e95d82).
...
- [Hébergement d’un contrôle Composite WPF dans Windows Forms, exemple](http://go.microsoft.com/fwlink/?LinkID=160001)