...
Texte avec effet de flou  
 ...
 ![Texte mis à l’échelle avec ScaleTransform](../../../../docs/framework/wpf/advanced/media/transformedtext02.jpg "TransformedText02")  
...
Texte avec SkewTransform  
 ...
 ![Capture d’écran : effet de rotation du texte du](../../../../docs/framework/wpf/advanced/media/texteffect01.jpg "TextEffect01")  
...
#### <a name="using-flow-documents"></a>Utilisation de documents dynamiques  
 ...
 ![Exemple de polices à l’aide de OpenType capture d’écran](../../../../docs/framework/wpf/advanced/media/typographyinwpf-03.png "TypographyInWPF_03")  
...
### <a name="lightweight-text-drawing"></a>Dessin de texte léger  
 ...
 ![Texte affiché avec l’objet FormattedText](../../../../docs/framework/wpf/advanced/media/formattedtext01.jpg "FormattedText01")  
...
Exemple de pinceau image appliqué au trait et surbrillance  
 ...
 Pour plus d’informations sur la <xref:System.Windows.Media.FormattedText> d’objets, consultez [dessin du texte mis en forme](../../../../docs/framework/wpf/advanced/drawing-formatted-text.md).  
