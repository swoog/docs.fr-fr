...
-   [x:Static](../../../../docs/framework/xaml-services/x-static-markup-extension.md): Active une référence qui retourne une valeur statique qui n’est pas une propriété compatible XAML.  
