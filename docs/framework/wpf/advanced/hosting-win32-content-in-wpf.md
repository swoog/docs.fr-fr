...
```  
 ...
 Les deux MSG possèdent les mêmes données, mais il est parfois plus facile de travailler avec la définition non gérée, donc dans cet exemple, vous pouvez définir la routine de conversion évident :  
...
```  
 ...
 ![Capture d’écran : application WPF](./media/interoparch09.PNG "InteropArch09")  
