...
-   Vous souhaitez que les propriétés d’un contrôle personnalisé pour recevoir le Concepteur de Visual Studio WPF prennent en charge, tel que **propriétés** édition de la fenêtre. Pour plus d’informations, consultez [Vue d’ensemble de la création de contrôles](../../../../docs/framework/wpf/controls/control-authoring-overview.md).
