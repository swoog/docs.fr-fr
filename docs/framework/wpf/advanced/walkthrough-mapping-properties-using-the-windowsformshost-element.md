...
---
# <a name="walkthrough-mapping-properties-using-the-windowsformshost-element"></a>Procédure pas à pas : Propriétés de mappage à l’aide de l’élément WindowsFormsHost
