...
## <a name="creating-textboxes"></a>Création de contrôles TextBox  
 ...
 Pour plus d’informations sur les différentes tâches associées à l’aide un <xref:System.Windows.Controls.TextBox>, consultez [rubriques de procédures](../../../../docs/framework/wpf/controls/textbox-how-to-topics.md).  
