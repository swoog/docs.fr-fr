...
|Objets <xref:System.Windows.DependencyObject>.|Vous pouvez lier aux propriétés de dépendance de n’importe quel <xref:System.Windows.DependencyObject>. Pour obtenir un exemple, consultez [Lier les propriétés de deux contrôles](../../../../docs/framework/wpf/data/how-to-bind-the-properties-of-two-controls.md).|  
