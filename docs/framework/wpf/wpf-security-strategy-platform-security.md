...
#### <a name="gs-compilation"></a>Compilation /GS  
 ...
 [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)] est compilé avec l’indicateur /GS pour ajouter encore une autre couche de défense pour [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)] applications.  
  
#### <a name="microsoft-windows-update-enhancements"></a>Améliorations de Microsoft Windows Update  
 [!INCLUDE[TLA#tla_win_update](../../../includes/tlasharptla-win-update-md.md)] a également été amélioré dans [!INCLUDE[TLA2#tla_winxpsp2](../../../includes/tla2sharptla-winxpsp2-md.md)] pour simplifier le processus pour télécharger et installer les mises à jour. Ces modifications améliorent considérablement la sécurité pour les clients [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)] en s'assurant que leurs systèmes sont à jour, en particulier en ce qui concerne les mises à jour de sécurité.  
  
<a name="Windows_Vista"></a>   
### <a name="windows-vista"></a>Windows Vista  
 [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)] les utilisateurs sur [!INCLUDE[TLA#tla_longhorn](../../../includes/tlasharptla-longhorn-md.md)] bénéficieront d’améliorations de sécurité supplémentaires du système d’exploitation, y compris « Privilèges utilisateur accès », contrôles d’intégrité du code et l’isolation des privilèges.  
...
#### <a name="code-integrity-checks"></a>Contrôles d'intégrité du code  
 [!INCLUDE[TLA#tla_longhorn](../../../includes/tlasharptla-longhorn-md.md)] incorpore les vérifications d’intégrité de code plus approfondies pour aider à empêcher un code malveillant soit injecté dans les fichiers système ou dans le noyau au moment de chargement/exécution. Cela va au-delà de la protection des fichiers système.  
...
### <a name="validation-and-verification"></a>Validation et vérification  
 Pour assurer l'isolation et l'intégrité des assemblys, le [!INCLUDE[TLA2#tla_clr](../../../includes/tla2sharptla-clr-md.md)] utilise un processus de validation. [!INCLUDE[TLA2#tla_clr](../../../includes/tla2sharptla-clr-md.md)] la validation garantit que les assemblys sont isolés en validant leur format de fichier exécutable Portable (PE) pour les adresses qui pointent vers l’extérieur de l’assembly. [!INCLUDE[TLA2#tla_clr](../../../includes/tla2sharptla-clr-md.md)] la validation vérifie également l’intégrité des métadonnées qui sont incorporée dans un assembly.  
...
-   nombreuses boîtes de dialogue de sécurité sur certains sites web.  
 ...
 [!INCLUDE[TLA2#tla_ie7](../../../includes/tla2sharptla-ie7-md.md)] intègre et étend les fonctionnalités de sécurité [!INCLUDE[TLA2#tla_ie6sp2](../../../includes/tla2sharptla-ie6sp2-md.md)] dans le cadre de son engagement continu à la sécurité.  
