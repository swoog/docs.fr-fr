...
-   <xref:System.Composition?displayProperty=nameWithType> fournit des classes qui constituent le MEF de base des applications [!INCLUDE[win8_appname_long](../../../includes/win8-appname-long-md.md)].  
  
-   <xref:System.Composition.Convention?displayProperty=nameWithType> fournit des types qui prennent en charge l’utilisation de MEF avec un modèle de configuration basé sur une convention.  
  
-   <xref:System.Composition.Hosting?displayProperty=nameWithType> fournit des types MEF utiles aux développeurs d’applications hôtes.  
...
- [Vue d’ensemble de .NET pour les applications du Windows Store](https://go.microsoft.com/fwlink/p/?LinkID=238312)
