...
-   <xref:System.Composition.Hosting.Core?displayProperty=nameWithType> fournit des types MEF utilisés en interne par le moteur de composition.  
 ...
 Pour obtenir plus d’informations sur [!INCLUDE[net_win8_profile](../../../includes/net-win8-profile-md.md)] et une liste des espaces de noms et des types qu’il contient, consultez [Vue d’ensemble de .NET pour les applications Windows Store](http://go.microsoft.com/fwlink/p/?LinkID=238312) dans le Centre de développement Windows.  
  
## <a name="see-also"></a>Voir aussi  
 [Vue d’ensemble de .NET pour les applications Windows Store](http://go.microsoft.com/fwlink/p/?LinkID=238312)  
