...
---
# <a name="performance-linq-to-xml-c"></a>Performances (LINQ to XML) (C#)
...
## <a name="in-this-section"></a>Dans cette section  
 [Performance des requêtes chaînées (LINQ to XML) (C#)](../../../../csharp/programming-guide/concepts/linq/performance-of-chained-queries-linq-to-xml.md)  
 ...
 [Préatomisation des objets XName (LINQ to XML) (C#)](../../../../csharp/programming-guide/concepts/linq/pre-atomization-of-xname-objects-linq-to-xml.md)  
 ...
 [Requêtes compilées statiquement (LINQ to XML) (C#)](../../../../csharp/programming-guide/concepts/linq/statically-compiled-queries-linq-to-xml.md)  
