...
## <a name="assembly-manifest"></a>Manifeste d'assembly  
 Il existe un *manifeste d’assembly* dans tous les assemblys. Semblable à une table des matières, le manifeste d’assembly contient les éléments suivants :  
