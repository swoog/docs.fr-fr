...
Le commentaire XML sur 'construction' contient du code XML mal rédigé — 'raison'  
 ...
 Quand vous utilisez [/doc](../../csharp/language-reference/compiler-options/doc-compiler-option.md), tous les commentaires du code source doivent être au format XML. Les erreurs de balisage XML génèrent l’avertissement CS1570. Par exemple :  
