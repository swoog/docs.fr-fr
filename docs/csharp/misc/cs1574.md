...
Le commentaire XML sur 'construction' comporte une erreur de syntaxe au niveau de l’attribut cref 'nom'  
 ...
 Une chaîne passée à une balise cref, par exemple, au sein d’un \<exception > balise, auquel un membre qui n’est pas disponible dans l’environnement de génération en cours. La chaîne que vous passez à une balise cref doit correspondre au nom d’un membre ou d’un champ ayant une syntaxe correcte.  
