...
L'assignation dans une expression conditionnelle est toujours constante ; voulez-vous utiliser == au lieu de = ?  
 ...
 Une expression conditionnelle a utilisé l’ [opérateur =](../../csharp/language-reference/operators/assignment-operator.md) et non l’ [opérateur ==](../../csharp/language-reference/operators/equality-operators.md#equality-operator-).
