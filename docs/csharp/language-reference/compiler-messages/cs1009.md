...
Séquence d’échappement non reconnue  
 ...
 Un caractère inattendu suit une barre oblique inverse (\\) dans un élément [string](../../../csharp/language-reference/keywords/string.md). Le compilateur attend l’un des caractères d’échappement valides. Pour plus d'informations, consultez [Character Escapes](../../../standard/base-types/character-escapes-in-regular-expressions.md).  
