...
Le mot clé contextuel `on` est utilisée dans la [clause join](../../../csharp/language-reference/keywords/join-clause.md) d’une expression de requête pour spécifier la condition de jointure.  
