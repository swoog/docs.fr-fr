...
`switch` est une instruction de sélection qui choisit une *section switch* précise à exécuter parmi une liste de candidats en fonction d’une *expression de correspondance* avec un modèle.
