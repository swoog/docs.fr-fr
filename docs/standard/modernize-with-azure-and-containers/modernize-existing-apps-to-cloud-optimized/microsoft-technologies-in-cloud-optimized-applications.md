...
-   **Cycle de vie application**: [Visual Studio Team Services](https://www.visualstudio.com/team-services/) et d’autres outils, tels que de Jenkins, sont des serveurs automation intégrés qui vous aident à implémenter pipelines CI/CD, y compris la gestion de version.
