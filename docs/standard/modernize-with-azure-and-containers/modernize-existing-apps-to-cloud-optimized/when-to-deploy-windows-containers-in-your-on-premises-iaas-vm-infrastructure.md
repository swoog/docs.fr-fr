...
-   Votre organisation ne peut pas être prête à déplacer vers le cloud, ou il peut ne pas pouvoir déplacer vers le cloud pour une raison métier. Toutefois, vous pouvez toujours obtenir les avantages de l’utilisation de conteneurs Windows dans vos propres centres de données.
