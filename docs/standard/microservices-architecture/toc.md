...
### [Exploration des nouvelles tentatives d’appel HTTP personnalisé avec interruption exponentielle](implement-resilient-applications/explore-custom-http-call-retries-exponential-backoff.md)
