...
* Implémentation client/serveur SignalR ASP.NET. Actuellement, [ASP.NET SignalR](https://github.com/aspnet/SignalR) est disponible en mode Preview avec ASP.NET Core 2.1.
