...
<a name="consoleApp"></a>   
1.  Dans [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)], créez un projet **Application console** Visual Basic ou Visual C#. Dans ce document, le projet est nommé `DataflowBatchDatabase`.  
