...
## <a name="remarks"></a>Notes  
 ...
 Pour plus d’informations sur la création du manifeste, consultez [-win32manifest (Visual Basic)](../../../visual-basic/reference/command-line-compiler/win32manifest.md).  
