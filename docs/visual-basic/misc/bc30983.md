...
---
# <a name="type-of-ltvariablenamegt-is-ambiguous-because-the-loop-bounds-and-the-step-variable-do-not-widen-to-the-same-type"></a>Type de '&lt;variablename&gt;' est ambigu, car les limites de la boucle et la variable étape s’étend pas au même type
