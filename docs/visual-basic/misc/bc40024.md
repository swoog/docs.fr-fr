...
---
# <a name="property-ltpropertynamegt-implicitly-declares-ltimplicitmembernamegt-which-conflicts-with-a-member-implicitly-declared-for-member-ltmembernamegt-in-the-base-class-ltbaseclassnamegt"></a>Propriété '&lt;propertyname&gt;'déclare implicitement'&lt;nom_membre_implicite&gt;', qui est en conflit avec un membre implicitement déclaré pour le membre'&lt;membername&gt;» dans la base la classe&lt;nom_classe_base&gt;'
