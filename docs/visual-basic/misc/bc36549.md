...
---
# <a name="anonymous-type-property-ltpropertynamegt-cannot-be-used-in-the-definition-of-a-lambda-expression-within-the-same-initialization-list"></a>Propriété de type anonyme '&lt;propertyname&gt;' ne peut pas être utilisé dans la définition d’une expression lambda au sein de la même liste d’initialisation
