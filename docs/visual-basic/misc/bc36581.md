...
---
# <a name="type-arguments-for-extension-method-methodname-defined-in-typename-could-not-be-inferred-from-the-delegate-delagatename"></a>Arguments de type pour la méthode d’extension '\<Nom_méthode >' définie dans '\<typeName >' n’a pas pu être inférés à partir du délégué '\<Nom_délégué >'
