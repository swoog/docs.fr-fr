...
---
# <a name="data-types-of-the-type-parameters-in-method-ltmethodnamegt-cannot-be-inferred-from-these-arguments-because-they-do-not-convert-to-the-same-type"></a>Ou les types de données des paramètres de type dans la méthode '&lt;nom_méthode&gt;' ne peut pas être déduit à partir de ces arguments, car ils ne sont pas convertis vers le même type
