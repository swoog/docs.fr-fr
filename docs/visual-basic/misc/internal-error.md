...
Une erreur interne s’est produite dans [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)].  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Raise, méthode (objet Err)](http://msdn.microsoft.com/library/80ffe307-57f1-4ef5-92d7-8ae7b6ec3f42)
