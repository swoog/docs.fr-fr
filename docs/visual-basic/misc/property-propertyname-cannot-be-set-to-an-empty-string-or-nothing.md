...
---
# <a name="property-propertyname-cannot-be-set-to-an-empty-string-or-nothing"></a>Propriété \<propertyname > ne peut pas être définie sur une chaîne vide ou Nothing
