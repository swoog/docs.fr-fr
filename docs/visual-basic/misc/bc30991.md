...
---
# <a name="member-ltmembernamegt-cannot-be-initialized-in-an-object-initializer-expression-because-it-is-shared"></a>Membre '&lt;membername&gt;' ne peut pas être initialisée dans une expression d’initialiseur d’objet, car il est partagé
