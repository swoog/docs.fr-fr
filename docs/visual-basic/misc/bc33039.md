...
---
# <a name="return-and-parameter-types-of-ltoperatorgt-must-be-lttypenamegt-to-be-used-in-a-for-statement"></a>Types de retour et de paramètres de '&lt;opérateur&gt;'doit être'&lt;typename&gt;' à utiliser dans une instruction 'For'
