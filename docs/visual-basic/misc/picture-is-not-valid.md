...
1.  Vérifiez que le fichier que vous voulez charger dans le `Picture` propriété est un fichier graphique valide pris en charge par Visual Basic.  
  
## <a name="see-also"></a>Voir aussi  
 [Modifications des graphismes dans Visual Basic .NET](https://msdn.microsoft.com/library/24cd2d55-ebf1-42d6-b755-00e9001f1cb8)
