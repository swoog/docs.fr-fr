...
1.  Vérifiez que le fichier que vous essayez de charger dans la propriété `Picture` est un fichier graphique valide pris en charge par [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)].  
  
## <a name="see-also"></a>Voir aussi  
 [Modifications des graphismes dans Visual Basic .NET](http://msdn.microsoft.com/library/24cd2d55-ebf1-42d6-b755-00e9001f1cb8)
