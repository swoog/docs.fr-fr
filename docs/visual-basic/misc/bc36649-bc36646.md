...
---
# <a name="data-types-of-the-type-parameters-in-extension-method-ltmethodnamegt-defined-in-lttypenamegt-cannot-be-inferred-from-these-arguments"></a>Ou les types de données des paramètres de type dans la méthode d’extension '&lt;nom_méthode&gt;'définie dans'&lt;typename&gt;' ne peut pas être déduit à partir de ces arguments
