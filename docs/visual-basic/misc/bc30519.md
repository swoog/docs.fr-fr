...
---
# <a name="overload-resolution-failed-because-no-accessible-ltmethodgt-can-be-called-without-a-narrowing-conversion-lterrorgt"></a>A échoué, car la résolution de surcharge n’accessible '&lt;méthode&gt;» peut être appelé sans conversion restrictive : &lt;erreur&gt;
