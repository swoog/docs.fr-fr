...
---
# <a name="trycast-operands-must-be-class-constrained-type-parameters-but-lttypeparameternamegt-has-no-class-constraint"></a>Opérande ' TryCast ' doit être un paramètre de type contraint par classe, mais '&lt;nom_paramètre_type&gt;' n’a aucune contrainte de classe
