...
---
# <a name="type-lttypenamegt-has-no-type-parameters-and-so-cannot-have-type-arguments"></a>Type '&lt;typename&gt;' n’a aucun type paramètres et donc ne peut pas avoir d’arguments de type
