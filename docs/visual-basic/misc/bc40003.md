...
---
# <a name="type1-membername-shadows-an-overloadable-member-declared-in-the-base-type2-classname"></a>\<type1 > '\<nom_membre >' masque un membre surchargeable déclaré dans la base de \<type2 > '\<nom_classe >'
