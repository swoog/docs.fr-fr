...
---
# <a name="variable-ltvariablenamegt-is-passed-by-reference-before-it-has-been-assigned-a-value"></a>Variable '&lt;variablename&gt;' est passée par référence avant une valeur lui ait été assignée
