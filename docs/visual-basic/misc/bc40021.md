...
---
# <a name="member-ltmembernamegt-conflicts-with-member-ltmembernamegt-in-the-base-type-ltbasetypenamegt-and-so-should-not-be-declared-overloads"></a>Membre '&lt;membername&gt;'est en conflit avec le membre'&lt;membername&gt;' du type de base '&lt;nom_type_base&gt;» et par conséquent, ne doit ne pas être déclaré 'Overloads'
