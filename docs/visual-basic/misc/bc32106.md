...
---
# <a name="type-argument-lttypeargumentnamegt-does-not-satisfy-the-class-constraint-for-type-parameter-lttypeparameternamegt"></a>Argument de type '&lt;nom_argument_type&gt;'ne satisfait pas la contrainte 'Class' pour le paramètre de type'&lt;nom_paramètre_type&gt;'
