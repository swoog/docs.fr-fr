...
---
# <a name="property-accessors-cannot-be-declared-ltaccessmodifiergt-in-a-notoverridable-property"></a>Les accesseurs de propriété ne peut pas être déclarés '&lt;accessmodifier&gt;' dans une propriété 'NotOverridable'
