...
- [Procédure : déclarer une propriété avec des niveaux d’accès mixtes](../../visual-basic/programming-guide/language-features/procedures/how-to-declare-a-property-with-mixed-access-levels.md)
