...
---
# <a name="variable-ltvariablenamegt-is-passed-by-reference-before-it-has-been-assigned-a-value-structure-variable"></a>Variable '&lt;variablename&gt;' est passée par référence avant qu’il ait été attribuée une valeur (Variable de Structure)
