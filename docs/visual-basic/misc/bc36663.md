...
---
# <a name="option-strict-on-does-not-allow-narrowing-in-implicit-type-conversions-between-method-ltmethodnamegt-and-delegate-ltdelegatenamegt"></a>Option Strict On n’autorise pas conversions restrictives lors des conversions de types implicites entre la méthode '&lt;nom_méthode&gt;« et délégué »&lt;nom_délégué&gt;'
