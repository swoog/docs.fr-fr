...
---
# <a name="ltmessagegt-this-error-could-also-be-due-to-mixing-a-file-reference-to-ltfilename1gt-in-project-ltprojectname1gt-with-a-file-reference-to-ltfilename2gt-in-project-ltprojectname2gt"></a>&lt;message&gt; cette erreur peut également être en raison d’une combinaison d’une référence de fichier pour '&lt;nom_fichier1&gt;'in project'&lt;nom_projet1&gt;'avec une référence de fichier pour'&lt;nom_fichier2&gt;» dans projet «&lt;nom_projet2&gt;'
