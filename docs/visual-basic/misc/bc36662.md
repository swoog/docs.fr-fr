...
---
# <a name="option-strict-on-does-not-allow-narrowing-in-implicit-type-conversions-between-the-lambda-expression-and-delegate-ltdelegatenamegt"></a>Option Strict On n’autorise pas conversions restrictives lors des conversions de types implicites entre l’expression lambda et le délégué '&lt;nom_délégué&gt;'
