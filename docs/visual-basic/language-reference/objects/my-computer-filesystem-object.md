...
> [!NOTE]
>  Vous pouvez également utiliser les classes dans le <xref:System.IO?displayProperty=nameWithType> fonctionne avec les lecteurs, fichiers et répertoires de l’espace de noms.  
