...
## <a name="remarks"></a>Notes  
 Pour plus d’informations sur les méthodes et propriétés de la `My.Computer.Registry` d’objets, consultez <xref:Microsoft.VisualBasic.MyServices.RegistryProxy>.  
