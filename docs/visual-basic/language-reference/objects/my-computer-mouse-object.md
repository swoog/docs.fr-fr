...
## <a name="remarks"></a>Notes  
 Pour plus d’informations sur les méthodes et propriétés de la `My.Computer.Mouse` d’objets, consultez <xref:Microsoft.VisualBasic.Devices.Mouse>.  
  
 Pour plus d’informations, consultez [l’accès à la souris](../../../visual-basic/developing-apps/programming/computer-resources/accessing-the-mouse.md).  
