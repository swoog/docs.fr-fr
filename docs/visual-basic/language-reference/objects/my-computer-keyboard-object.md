---
title: My.Computer.Keyboard (objet) (Visual Basic)
ms.date: 07/20/2015
helpviewer_keywords:
...
## <a name="remarks"></a>Notes  
 Pour plus d’informations sur les méthodes et propriétés de la `My.Computer.Keyword` d’objets, consultez <xref:Microsoft.VisualBasic.Devices.Keyboard>.  
