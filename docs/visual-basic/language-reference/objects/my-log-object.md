...
## <a name="remarks"></a>Notes  
 Pour plus d’informations sur les méthodes et propriétés de la `My.Log` d’objets, consultez <xref:Microsoft.VisualBasic.Logging.AspLog>.  
