...
---
# <a name="xml-namespace-uri-httpwwww3orgxml1998namespace-can-be-bound-only-to-xmlns"></a>URI d’espace de noms XML `http://www.w3.org/XML/1998/namespace`; peut être lié qu’à 'xmlns'
