...
Vous avez essayé d’utiliser une variable définie dans une bibliothèque de types ou de la bibliothèque d’objets ayant un type de données non pris en charge par Visual Basic.  
