...
L’opération ne peut pas être effectuée car la taille maximale de mémoire tampon (10 000 000 octets) a été dépassée.  
  
## <a name="to-correct-this-error"></a>Pour corriger cette erreur  
  
-   Ne vérifiez qu’aucun champ incorrect dans le fichier.  
