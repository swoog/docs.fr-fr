...
|Appeler une méthode ou propriété.|<xref:Microsoft.VisualBasic.Interaction.CallByName%2A>|  
|Son d’un signal sonore à partir de l’ordinateur.|<xref:Microsoft.VisualBasic.Interaction.Beep%2A>|  
...
|Boîtes de dialogue|<xref:Microsoft.VisualBasic.Interaction.InputBox%2A>, <xref:Microsoft.VisualBasic.Interaction.MsgBox%2A>|  
