...
|Obtenir la valeur absolue.|<xref:System.Math.Abs%2A>|  
|Obtenir le signe d’une expression.|<xref:System.Math.Sign%2A>|  
|Conversions numériques.|<xref:Microsoft.VisualBasic.Conversion.Fix%2A>, <xref:Microsoft.VisualBasic.Conversion.Int%2A>|  
