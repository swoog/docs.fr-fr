...
|-------------------|----------------------|-------------------------------------|  
|`CBool`|[Type de données booléen](../../../visual-basic/language-reference/data-types/boolean-data-type.md)|Valide `Char` ou `String` ou expression numérique.|  
...
|`CDate`|[Type de données date](../../../visual-basic/language-reference/data-types/date-data-type.md)|Une représentation valide d’une date et une heure.|  
