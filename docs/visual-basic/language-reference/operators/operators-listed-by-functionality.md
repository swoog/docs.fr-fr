...
Consultez une des catégories répertoriées ci-dessous ou ouvrez cette partie de la table des matières pour une liste alphabétique d’aide [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] opérateurs.  
...
|[opérateur de concaténation](../../../visual-basic/language-reference/operators/concatenation-operators.md)|Ces opérateurs combinent des chaînes.|  
