...
## <a name="in-this-section"></a>Dans cette section
 ...
 [Opérateurs logiques/au niveau du bit](logical-bitwise-operators.md)  
  
 [Opérateurs divers](miscellaneous-operators.md)  
  
## <a name="related-sections"></a>Rubriques connexes  
 [Références du langage Visual Basic](../../../visual-basic/language-reference/index.md)  
