...
|-----------|-----------------|  
|[LINQ to XML, présentation (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/linq-to-xml-overview.md)|Fournit une vue d’ensemble de la technologie LINQ to XML.|  
