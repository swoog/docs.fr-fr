...
---
# <a name="how-to-stream-xml-fragments-with-access-to-header-information-visual-basic"></a>Procédure : Stream des fragments XML en continu avec accès aux informations d’en-tête (Visual Basic)
