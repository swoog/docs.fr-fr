...
> [!NOTE]
>  Le [!INCLUDE[linq_adonet](~/includes/linq-adonet-md.md)] documentation se trouve dans la section ADO.NET du kit SDK .NET Framework : [LINQ et ADO.NET](../../../../framework/data/adonet/linq-and-ado-net.md).
