...
---
# <a name="how-to-populate-an-xml-tree-with-an-xmlwriter-linq-to-xml-visual-basic"></a>Procédure : Remplir une arborescence XML avec un XmlWriter (LINQ to XML) (Visual Basic)
