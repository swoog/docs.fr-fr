...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Compilées statiquement des requêtes (LINQ to XML) (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/statically-compiled-queries-linq-to-xml.md)  
