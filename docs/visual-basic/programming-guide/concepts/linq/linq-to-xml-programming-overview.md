...
|[Comment : générer des exemples LINQ to XML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-build-linq-to-xml-examples.md)|Contient le `Imports` instructions qui sont nécessaires pour générer l’exemples LINQ to XML.|  
