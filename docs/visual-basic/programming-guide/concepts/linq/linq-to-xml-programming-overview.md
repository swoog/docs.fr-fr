...
---
# <a name="linq-to-xml-programming-overview-visual-basic"></a>LINQ à la vue d’ensemble de programmation XML (Visual Basic)
...
|[Comment : générer des exemples LINQ to XML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-build-linq-to-xml-examples.md)|Contient le `Imports` instructions qui sont requises pour générer l’exemples LINQ to XML.|  
