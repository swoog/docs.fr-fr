...
- [Stockage de valeurs dans un tableau](#storing-values-in-an-array)  
  
- [Remplissage d’un tableau avec des littéraux de tableau](#populating-an-array-with-array-literals)  
  
- [Itération au sein d’un tableau](#iterating-through-an-array)  
...
- Vous pouvez spécifier la taille lorsque le tableau est déclaré :
 ...
 Pour plus d’informations, consultez le [instruction ReDim](../../../../visual-basic/language-reference/statements/redim-statement.md).  
