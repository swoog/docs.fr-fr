...
Vous pouvez personnaliser les modèles de projet pour fournir plus `My` objets. Cela facilite par d’autres développeurs à trouver et utiliser vos objets.  
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit comment publier personnalisé `My` extensions de l’espace de noms à l’aide de modèles Visual Studio.  
 ...
 Décrit comment contrôler qui `My` les objets sont activés en définissant la constante de compilation conditionnelle _MYTYPE de votre projet.  
  
## <a name="related-sections"></a>Rubriques connexes  
 [Développement avec My](../../../visual-basic/developing-apps/development-with-my/index.md)  
 Qui décrit `My` objets sont disponibles dans différents types de projet par défaut.  
 ...
 Décrit comment le compilateur utilise la compilation conditionnelle pour sélectionner des sections de code pour compiler et exclure les autres sections.  
