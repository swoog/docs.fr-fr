...
### <a name="data-binding"></a>Liaison de données  
 ...
 Vous pouvez également afficher des contrôles indépendants sur un <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater> contrôle. Par exemple, vous pouvez afficher une image qui est répétée sur chaque élément. Pour plus d'informations, voir [Procédure : Afficher les contrôles dans un contrôle DataRepeater indépendants](../../../visual-basic/developing-apps/windows-forms/how-to-display-unbound-controls-in-a-datarepeater-control-visual-studio.md).  
