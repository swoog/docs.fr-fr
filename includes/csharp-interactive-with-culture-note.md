...
>
> Vous pouvez contourner cette limitation en ajoutant une ligne de code comme la suivante pour définir la culture : `System.Globalization.CultureInfo.CurrentCulture = new System.Globalization.CultureInfo("en-US");` Remplacez juste `en-US` par le nom de la culture actuelle.
